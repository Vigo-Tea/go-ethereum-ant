...
import (
	...
	"github.com/Vigo-Tea/go-ethereum-ant/crypto/signify"
	"github.com/Vigo-Tea/go-ethereum-ant/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/Vigo-Tea/go-ethereum-ant/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/Vigo-Tea/go-ethereum-ant/internal/version.gitDate="+env.Date)
	}
